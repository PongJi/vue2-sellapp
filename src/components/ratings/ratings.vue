...
<style type="text/css">
	...
	.ratings .view .view-left .score{
		margin-bottom: 6px;
		line-height: 28px;
		font-size: 24px;
		color: rgb(255, 153, 0);
	}
	.ratings .view .view-left .title{
		margin-bottom: 8px;
		line-height: 12px;
		font-size: 12px;
		color: rgb(7, 17, 27);
	}
	.ratings .view .view-left .rank{
		line-height: 10px;
		font-size: 10px;
		color: rgb(147, 153, 159);
	}
	.ratings .view .view-right{
		flex: 1;
		padding: 6px 0 6px 24px;
	}
	.ratings .view .view-right .score-wrapper{
		margin-bottom: 8px;
		font-size: 0;
	}
	.ratings .view .view-right .score-wrapper .title{
	...
	.ratings .view .view-right .score-wrapper .star{
		vertical-align: top;
		margin: 0 12px;
		display: inline-block;
	}
	.ratings .view .view-right .score-wrapper .score{
		display: inline-block;
		vertical-align: top;
		line-height: 18px;
		font-size: 12px;
	...
	.ratings .view .view-right .delivery-wrapper{
		font-size: 0;
	}
	.ratings .view .view-right .delivery-wrapper .title{
		line-height: 18px;
		font-size: 12px;
		color: rgb(7, 17, 27);
	}
	.ratings .view .view-right .delivery-wrapper .delivery{
		margin-left: 12px;
		font-size: 12px;
		color: rgb(147, 153, 159);
	}
